      ...
      <main className="flex-1 overflow-y-auto pb-32 no-scrollbar">
        ...
        <div className="px-6 space-y-6">
           ...
           <div className="space-y-4">
              ...
              <button className="w-full flex items-center justify-between p-4 bg-white dark:bg-[#1e242b] border dark:border-slate-800 rounded-2xl group transition-all active:scale-[0.99]">
